...
local covariates1 `cov_hs1' `cov_hs2' `cov_futstu' `cov_paredu' `cov_partch' `cov_tses'
...
ttest_cov_unwt, t(coaching) c(`covariates') b(`blocks') t(balance_table) p("-.25 .25 .25 1")
keep if _n==1
gen id=_n
drop student
drop email-coaching

drop id_participant - partch5
